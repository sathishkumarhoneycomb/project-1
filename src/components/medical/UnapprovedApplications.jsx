            ...
            <>
                <section>
                    <header className="py-4 text-center card rounded-0 mb-4">
                        <h4 className="text-uppercase text-success m-0"> List of Members - ALPA + BF (18 Members) </h4>
                    </header>
                        ...
                        <div className="mb-3 table-responsive">
                            <table className="table table-striped rounded-0">
                                ...
                                <tr>
                                    ...
                                    <td className="border border-2 py-3"> <span className="rounded-pill bg-primary text-white px-2 fw-semibold py-1 small_text"> Active </span>  </td>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px" className="add_suggestion_icon cursor_pointer">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px" className="upload_icon cursor_pointer">
...
export default UnapprovedApplications;
