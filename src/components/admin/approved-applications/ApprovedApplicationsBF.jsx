const ApprovedApplicationsBF = () => {
    return (
        <section>
        <header className="py-4 text-center card rounded-0">
            <h4 className="text-uppercase text-success m-0">List of Approved Applications - BF (387 Applications)
 </h4>
        </header>
...
export default ApprovedApplicationsBF;
