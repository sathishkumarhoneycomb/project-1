...
const ActiveOrdinaryMembers = () => {
    return (
        <section className="mb-5">
        <header className="py-4 text-center card rounded-0 ">
            <h4 className="text-uppercase text-success m-0"> List of Active Members - ORDINARY (290 Members)  </h4>
        </header>
            ...
            <div className="mb-3 table-responsive">
                <table className="table table-striped rounded-0">
                    ...
                    <tr>
                        ...
                        <td className="border border-2 py-2 "> <span className="d-block width_max_content px-1"> 2024-04-03 </span> </td>
                        <td className="border border-2 py-2"> <span className="rounded-pill bg-primary text-white px-2 fw-semibold py-1 small_text"> Active </span>  </td>
                        <td className="border border-2 py-2"> 
                    ...
                    <tr>
                        ...
                        <td className="border border-2 py-2"> 
                        <svg xmlns="http://www.w3.org/2000/svg" height="34px" viewBox="0 -960 960 960" width="34px" 
                        className="fill_dark_green"
                        ><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg>
                         </td>
                        <td className="border border-2 py-2"> 2024-04-03 </td>
                        <td className="border border-2 py-2"> 2024-04-03 </td>
                        <td className="border border-2 py-2"> <span className="rounded-pill bg-primary text-white px-2 fw-semibold py-1 small_text"> Active </span>  </td>
                        <td className="border border-2 py-2"> 
                        <div className="d-flex gap-3">
...
export default ActiveOrdinaryMembers;
