  ...
  return (
    ...
    <div className='w-100 overflow-hidden'>
        ...
        <Offcanvas.Body className='d-flex  flex-column justify-content-between'>
          ...
          <hr />
            <span>
              <h6 className="mt-1 mb-0 text-center">Alpa India - Admin Portal</h6>
            </span>
          </div>
        </Offcanvas.Body>
      </Offcanvas>
      ...
      <div className="d-flex flex-column flex-md-row">
        ...
        <div className=''>
          ...
          <Nav.Link href="/admin/dashboard"className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/dashboard"  ? "active " : "" }`}>
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M520-600v-240h320v240H520ZM120-440v-400h320v400H120Zm400 320v-400h320v400H520Zm-400 0v-240h320v240H120Zm80-400h160v-240H200v240Zm400 320h160v-240H600v240Zm0-480h160v-80H600v80ZM200-200h160v-80H200v80Zm160-320Zm240-160Zm0 240ZM360-280Z"/></svg>     
           Dashboard 
            </Nav.Link>
            
          <Nav.Link href="/admin/profile"className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/profile"  ? "active " : "" }`}>
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T560-640q0-33-23.5-56.5T480-720q-33 0-56.5 23.5T400-640q0 33 23.5 56.5T480-560Zm0-80Zm0 400Z"/></svg>              
            Profile 
            </Nav.Link>

            <Nav.Link href="/admin/unapproved-applications"  className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/unapproved-applications"  ? "active" : "" }`}>
            ...
            <Nav.Link href="/admin/approved-applications" className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/approved-applications"  ? "active" : "" }`}>
            ...
            <Nav.Link href="/admin/pilots" className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/pilots"  ? "active" : "" }`}>
            ...
            <Nav.Link href="/admin/alpa-bf-members" className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/alpa-bf-members"  ? "active" : "" }`}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M40-160v-112q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q66 0 130 15.5T616-378q29 15 46.5 43.5T680-272v112H40Zm720 0v-120q0-44-24.5-84.5T666-434q51 6 96 20.5t84 35.5q36 20 55 44.5t19 53.5v120H760ZM360-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47Zm400-160q0 66-47 113t-113 47q-11 0-28-2.5t-28-5.5q27-32 41.5-71t14.5-81q0-42-14.5-81T544-792q14-5 28-6.5t28-1.5q66 0 113 47t47 113ZM120-240h480v-32q0-11-5.5-20T580-306q-54-27-109-40.5T360-360q-56 0-111 13.5T140-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T440-640q0-33-23.5-56.5T360-720q-33 0-56.5 23.5T280-640q0 33 23.5 56.5T360-560Zm0 320Zm0-400Z"/></svg>            
            Member - BF 
            </Nav.Link>

            <Nav.Link href="/admin/alpa-users" className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/alpa-users"  ? "active" : "" }`}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M40-160v-112q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q66 0 130 15.5T616-378q29 15 46.5 43.5T680-272v112H40Zm720 0v-120q0-44-24.5-84.5T666-434q51 6 96 20.5t84 35.5q36 20 55 44.5t19 53.5v120H760ZM360-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47Zm400-160q0 66-47 113t-113 47q-11 0-28-2.5t-28-5.5q27-32 41.5-71t14.5-81q0-42-14.5-81T544-792q14-5 28-6.5t28-1.5q66 0 113 47t47 113ZM120-240h480v-32q0-11-5.5-20T580-306q-54-27-109-40.5T360-360q-56 0-111 13.5T140-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T440-640q0-33-23.5-56.5T360-720q-33 0-56.5 23.5T280-640q0 33 23.5 56.5T360-560Zm0 320Zm0-400Z"/></svg>            
            Alpa Admins 
            </Nav.Link>

            <Nav.Link href="/admin/news-and-events" className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/news-and-events"  ? "active" : "" }`}>
            ...
            <Nav.Link href="/admin/discussion-forum" className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/discussion-forum"  ? "active" : "" }`}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M880-80 720-240H320q-33 0-56.5-23.5T240-320v-40h440q33 0 56.5-23.5T760-440v-280h40q33 0 56.5 23.5T880-640v560ZM160-473l47-47h393v-280H160v327ZM80-280v-520q0-33 23.5-56.5T160-880h440q33 0 56.5 23.5T680-800v280q0 33-23.5 56.5T600-440H240L80-280Zm80-240v-280 280Z"/></svg>            
            Discussion Forum 
            </Nav.Link>

            <Nav.Link href="/admin/forms-downloaded" className={`text-white mb-2 d-flex align-items-center gap-3 ${currentPath == "/admin/forms-downloaded"  ? "active" : "" }`}>
