...
const InactiveBfMember = () => {
    return (
        <section className="mb-5">
        <header className="py-4 text-center card rounded-0 ">
            <h4 className="text-uppercase text-success m-0"> LIST OF UNPAID INACTIVE MEMBERS - BF (8 Members)  </h4>
        </header>
                ...
                <table className="table table-striped rounded-0">
                    <thead className="table-primary">
                        <tr className="border border-1 border-dark">
                            ...
                            <th className="border border-2 py-3"> Due Date  </th>
                    ...
                    <tr>
                        ...
                        <td className="border border-2 py-2"> <span className="rounded-pill bg-success text-white px-2 fw-semibold py-1 small_text"> Active </span>  </td>
                        <td className="border border-2 py-2"> 
...
export default InactiveBfMember;
