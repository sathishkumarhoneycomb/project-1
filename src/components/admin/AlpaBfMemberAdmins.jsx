...
const AlpaBfMemberAdmins = () => {
    return (
        <section>
        <header className="py-4 text-center card rounded-0 ">
            <h4 className="text-uppercase text-success m-0">List of ALPA Benevolent Fund Member Admins</h4>
        </header>
            ...
            <div className="mb-3 table-responsive">
                <table className="table table-striped rounded-0">
                    ...
                    <tr>
                        ...
                        <td className="border border-2 py-3"> <span className="rounded-pill bg-warning  text-dark px-2 fw-semibold py-1 small_text"> secondary </span> </td>
...
export default AlpaBfMemberAdmins;
